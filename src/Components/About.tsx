        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {teamMembers.map((member, index) => (
              ...
              >
                <motion.div 
                  className="relative mb-6 mx-auto w-64 h-64 rounded-full overflow-hidden border-4 border-gray-700 group-hover:border-blue-400 transition-all duration-500"
                ...
                >
                  ...
                  <p className="text-blue-400 text-lg font-medium">{member.position}</p>
                </motion.div>
              </motion.div>
            ))}
          </motion.div>
